...
type StripeIconProps = React.SVGProps<SVGSVGElement>;

const StripeIcon: React.FC<StripeIconProps> = (props) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className="icon icon-tabler icons-tabler-filled icon-tabler-brand-stripe"
    {...props}
  >
